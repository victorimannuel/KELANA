...
class ListSecondaryNewsAdapter(private val listBerita: ArrayList<News>, mListener : IUnews) : RecyclerView.Adapter<ListSecondaryNewsAdapter.ListViewHolder>() {
    ...
    class ListViewHolder(itemView: View,mListener : IUnews ) : RecyclerView.ViewHolder(itemView) {
        ...
        var tvExtends : TextView = itemView.findViewById(R.id.tv_selengkapnya)
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): ListViewHolder {
        val view: View = LayoutInflater.from(viewGroup.context)
            .inflate(R.layout.item_row_secondarynews, viewGroup, false)
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        ...
        holder.tvExtends.setOnClickListener { mView ->
            listBerita.clear()
